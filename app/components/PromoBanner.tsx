          ...
          <div className="relative z-10 px-8 py-12 md:px-16 md:py-20 flex flex-col md:flex-row items-center justify-between gap-6">
            <div>
              ...
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white tracking-tight leading-tight">
                Envío gratis
                <br />
                <span className="text-white/90">en tu primera compra</span>
              </h2>
            </div>

            <Link
              href="/tienda"
              className="group inline-flex items-center gap-2 px-8 py-4 bg-white text-[var(--color-primary)] font-semibold text-base rounded-full transition-all duration-500 hover:scale-105 active:scale-95 hover:shadow-xl shrink-0"
            >
              Aprovechar oferta
